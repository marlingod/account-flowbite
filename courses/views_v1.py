...
def teacher_course_detail(request, slug):
    ...
    # Check if user is the instructor or an admin
    if course.instructor != request.user and not request.user.is_admin_user():
        return HttpResponseForbidden(_("You don't have permission to view this course's management page."))
...
def publish_course(request, slug):
    ...
    # Check if user is the instructor or an admin
    if course.instructor != request.user and not request.user.is_admin_user():
        return HttpResponseForbidden(_("You don't have permission to publish this course."))
...
@login_required
@teacher_required
def unpublish_course(request, slug):
    """Unpublish a course"""
    course = get_object_or_404(Course, slug=slug)
    
    # Check if user is the instructor or an admin
    if course.instructor != request.user and not request.user.is_admin_user():
        return HttpResponseForbidden(_("You don't have permission to unpublish this course."))
...
def archive_course(request, slug):
    ...
    # Check if user is the instructor or an admin
    if course.instructor != request.user and not request.user.is_admin_user():
        return HttpResponseForbidden(_("You don't have permission to archive this course."))
